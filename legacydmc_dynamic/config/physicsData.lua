physicsSettings ={  
    ...
    assistsData = {
        enableAssistsByDefault = false,
        tcsIntensity = 4.0,
        escThresholdMultiplier = 1.0,
    },
    tunableData = {
        downforceGripGainCoeff = 0.025,
        linearDampeningCoefficient = 0.0125, 
        angularDampeningCoefficient = 0.025, 
    },
    transmissionData = {
    ...
    experienceData = {
        ...
        brakeHeatGeneratorMultiplier = 1.0 
    },
    upgradeData = {
